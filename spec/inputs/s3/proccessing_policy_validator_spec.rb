...
describe LogStash::Inputs::S3::ProcessingPolicyValidator do
  ...
  let(:validator_2) { LogStash::Inputs::S3::ProcessingPolicyValidator::SkipEndingDirectory }
  ...
  describe LogStash::Inputs::S3::ProcessingPolicyValidator::SkipEndingDirectory do
    subject { described_class }
  ...
  describe LogStash::Inputs::S3::ProcessingPolicyValidator::SkipEmptyFile do
    subject { described_class }
  ...
  describe LogStash::Inputs::S3::ProcessingPolicyValidator::IgnoreOlderThan do
    let(:older_than) { 3600 }
  ...
  describe LogStash::Inputs::S3::ProcessingPolicyValidator::AlreadyProcessed do
    let(:older_than) { 3600 }
  ...
  describe LogStash::Inputs::S3::ProcessingPolicyValidator::ExcludePattern do
  ...
  describe LogStash::Inputs::S3::ProcessingPolicyValidator::ExcludeBackupedFiles do
